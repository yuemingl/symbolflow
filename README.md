# symbolflow
SymbolFlow is a java wrapper of Google TensorFlow. A tensor graph can be created using operator overloading ([java-oo](https://github.com/amelentev/java-oo)) in Java .
